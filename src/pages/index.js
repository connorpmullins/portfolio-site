        ...
        <div id="main">
            ...
            <section id="one">
              <header className="major">
                <h2>
                  JavaScript - React.js - React Native - Redux - Express.js
                </h2>
              </header>
              <p>
                I develop mobile applications in React Native, build webgames in vanilla JavaScript,
                write web apps in React, construct servers with Express, and handle state management
                with Redux. I am self-taught, motivated, learn quickly, and am interested in
            ...
            <section id="three">
                <h2>Get In Touch</h2>
                <p>
                  If you're looking to hire a developer, want to use one of my codebases,
                  or just want to chat, reach out to me via phone, email, or the form below!
                </p>
                <div className="row">
                    ...
                    <div className="4u 12u$(small)">
                        <ul className="labeled-icons">
                            ...
                            <li>
                                ...
                                <a href="#">connorpmullins@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
